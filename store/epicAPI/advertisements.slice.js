...
export const api_v1_advertisement_list = createAsyncThunk("advertisements/api_v1_advertisement_list", async payload => {
  const response = await apiService.api_v1_advertisement_list(payload);
  return response.data;
});
export const api_v1_advertisement_create = createAsyncThunk("advertisements/api_v1_advertisement_create", async payload => {
  const response = await apiService.api_v1_advertisement_create(payload);
  return response.data;
});
export const api_v1_advertisement_retrieve = createAsyncThunk("advertisements/api_v1_advertisement_retrieve", async payload => {
  const response = await apiService.api_v1_advertisement_retrieve(payload);
  return response.data;
});
export const api_v1_advertisement_update = createAsyncThunk("advertisements/api_v1_advertisement_update", async payload => {
  const response = await apiService.api_v1_advertisement_update(payload);
  return response.data;
});
export const api_v1_advertisement_partial_update = createAsyncThunk("advertisements/api_v1_advertisement_partial_update", async payload => {
  const response = await apiService.api_v1_advertisement_partial_update(payload);
  return response.data;
});
export const api_v1_advertisement_destroy = createAsyncThunk("advertisements/api_v1_advertisement_destroy", async payload => {
