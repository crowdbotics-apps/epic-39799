...
export const api_v1_boardspot_list = createAsyncThunk("boardSpots/api_v1_boardspot_list", async payload => {
  const response = await apiService.api_v1_boardspot_list(payload);
  return response.data;
});
export const api_v1_boardspot_create = createAsyncThunk("boardSpots/api_v1_boardspot_create", async payload => {
  const response = await apiService.api_v1_boardspot_create(payload);
  return response.data;
});
export const api_v1_boardspot_retrieve = createAsyncThunk("boardSpots/api_v1_boardspot_retrieve", async payload => {
  const response = await apiService.api_v1_boardspot_retrieve(payload);
  return response.data;
});
export const api_v1_boardspot_update = createAsyncThunk("boardSpots/api_v1_boardspot_update", async payload => {
  const response = await apiService.api_v1_boardspot_update(payload);
  return response.data;
});
export const api_v1_boardspot_partial_update = createAsyncThunk("boardSpots/api_v1_boardspot_partial_update", async payload => {
  const response = await apiService.api_v1_boardspot_partial_update(payload);
  return response.data;
});
export const api_v1_boardspot_destroy = createAsyncThunk("boardSpots/api_v1_boardspot_destroy", async payload => {
