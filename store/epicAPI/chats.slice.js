...
export const api_v1_chat_list = createAsyncThunk("chats/api_v1_chat_list", async payload => {
  const response = await apiService.api_v1_chat_list(payload);
  return response.data;
});
export const api_v1_chat_create = createAsyncThunk("chats/api_v1_chat_create", async payload => {
  const response = await apiService.api_v1_chat_create(payload);
  return response.data;
});
export const api_v1_chat_retrieve = createAsyncThunk("chats/api_v1_chat_retrieve", async payload => {
  const response = await apiService.api_v1_chat_retrieve(payload);
  return response.data;
});
export const api_v1_chat_update = createAsyncThunk("chats/api_v1_chat_update", async payload => {
  const response = await apiService.api_v1_chat_update(payload);
  return response.data;
});
export const api_v1_chat_partial_update = createAsyncThunk("chats/api_v1_chat_partial_update", async payload => {
  const response = await apiService.api_v1_chat_partial_update(payload);
  return response.data;
});
export const api_v1_chat_destroy = createAsyncThunk("chats/api_v1_chat_destroy", async payload => {
