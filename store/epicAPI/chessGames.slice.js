...
export const api_v1_chessgame_list = createAsyncThunk("chessGames/api_v1_chessgame_list", async payload => {
  const response = await apiService.api_v1_chessgame_list(payload);
  return response.data;
});
export const api_v1_chessgame_create = createAsyncThunk("chessGames/api_v1_chessgame_create", async payload => {
  const response = await apiService.api_v1_chessgame_create(payload);
  return response.data;
});
export const api_v1_chessgame_retrieve = createAsyncThunk("chessGames/api_v1_chessgame_retrieve", async payload => {
  const response = await apiService.api_v1_chessgame_retrieve(payload);
  return response.data;
});
export const api_v1_chessgame_update = createAsyncThunk("chessGames/api_v1_chessgame_update", async payload => {
  const response = await apiService.api_v1_chessgame_update(payload);
  return response.data;
});
export const api_v1_chessgame_partial_update = createAsyncThunk("chessGames/api_v1_chessgame_partial_update", async payload => {
  const response = await apiService.api_v1_chessgame_partial_update(payload);
  return response.data;
});
export const api_v1_chessgame_destroy = createAsyncThunk("chessGames/api_v1_chessgame_destroy", async payload => {
