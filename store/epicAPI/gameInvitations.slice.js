...
export const api_v1_gameinvitation_list = createAsyncThunk("gameInvitations/api_v1_gameinvitation_list", async payload => {
  const response = await apiService.api_v1_gameinvitation_list(payload);
  return response.data;
});
export const api_v1_gameinvitation_create = createAsyncThunk("gameInvitations/api_v1_gameinvitation_create", async payload => {
  const response = await apiService.api_v1_gameinvitation_create(payload);
  return response.data;
});
export const api_v1_gameinvitation_retrieve = createAsyncThunk("gameInvitations/api_v1_gameinvitation_retrieve", async payload => {
  const response = await apiService.api_v1_gameinvitation_retrieve(payload);
  return response.data;
});
export const api_v1_gameinvitation_update = createAsyncThunk("gameInvitations/api_v1_gameinvitation_update", async payload => {
  const response = await apiService.api_v1_gameinvitation_update(payload);
  return response.data;
});
export const api_v1_gameinvitation_partial_update = createAsyncThunk("gameInvitations/api_v1_gameinvitation_partial_update", async payload => {
  const response = await apiService.api_v1_gameinvitation_partial_update(payload);
  return response.data;
});
export const api_v1_gameinvitation_destroy = createAsyncThunk("gameInvitations/api_v1_gameinvitation_destroy", async payload => {
