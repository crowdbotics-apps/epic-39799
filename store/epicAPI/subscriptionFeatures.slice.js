...
export const api_v1_subscriptionfeature_list = createAsyncThunk("subscriptionFeatures/api_v1_subscriptionfeature_list", async payload => {
  const response = await apiService.api_v1_subscriptionfeature_list(payload);
  return response.data;
});
export const api_v1_subscriptionfeature_create = createAsyncThunk("subscriptionFeatures/api_v1_subscriptionfeature_create", async payload => {
  const response = await apiService.api_v1_subscriptionfeature_create(payload);
  return response.data;
});
export const api_v1_subscriptionfeature_retrieve = createAsyncThunk("subscriptionFeatures/api_v1_subscriptionfeature_retrieve", async payload => {
  const response = await apiService.api_v1_subscriptionfeature_retrieve(payload);
  return response.data;
});
export const api_v1_subscriptionfeature_update = createAsyncThunk("subscriptionFeatures/api_v1_subscriptionfeature_update", async payload => {
  const response = await apiService.api_v1_subscriptionfeature_update(payload);
  return response.data;
});
export const api_v1_subscriptionfeature_partial_update = createAsyncThunk("subscriptionFeatures/api_v1_subscriptionfeature_partial_update", async payload => {
  const response = await apiService.api_v1_subscriptionfeature_partial_update(payload);
  return response.data;
});
export const api_v1_subscriptionfeature_destroy = createAsyncThunk("subscriptionFeatures/api_v1_subscriptionfeature_destroy", async payload => {
  const response = await apiService.api_v1_subscriptionfeature_destroy(payload);
  return response.data;
});
const initialState = {
  entities: [],
